    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (basilisk <= 0)
            {
                ...
                if (names.Count == 1)
                {
                    Console.WriteLine($"\n{names[0]} cries out from exhaustion as the basilisk finally collapses from the last blow. This was not a victory, this was only avoiding defeat. This was a battle they wish they could forget...\n");
                }
            }
